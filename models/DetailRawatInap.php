...
use app\models\HeaderRawatInap;

/**
 * This is the model class for table "detailrawatinap".
 *
 * @property int $id
 ...
 */
class DetailRawatInap extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    /**
     * {@inheritdoc}
     * @return DetailrawatinapQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new DetailrawatinapQuery(get_called_class());
    }
    ...
    {
        return $this->hasOne(HeaderRawatInap::className(), ['NoTransaksi' => 'NoTransaksi']);
    }
}
