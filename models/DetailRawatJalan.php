...
/**
 * This is the model class for table "detailrawatjalan".
 *
 * @property int $id_detailrawatjalan
 ...
 */
class DetailRawatJalan extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    public function rules()
    {
        return [
            ...
            [['KodeUnitPelayanan', 'KodeTKesehatan'], 'string', 'max' => 6],
            [['NoTransaksi', 'KodePelayanan', 'Kelas'], 'string', 'max' => 15],
            [['Cito'], 'string', 'max' => 1],
            [['KodeTarif'], 'string', 'max' => 30],
            [['user_input', 'user_delete'], 'string', 'max' => 10],
        ];
    }
    ...
    {
        return [
            'id_detailrawatjalan' => Yii::t('app', 'Id Detailrawatjalan'),
    ...
    /**
     * {@inheritdoc}
     * @return DetailrawatjalanQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new DetailrawatjalanQuery(get_called_class());
    }
    ...
    {
        return $this->hasOne(HeaderRawatJalan::className(), ['NoTransaksi' => 'NoTransaksi']);
    }
}
